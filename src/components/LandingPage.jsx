...
const LandingPage = ({ onJoin, onCreate, onUserChange, user, connected }) => {
    ...
    return (
        <div className="min-h-screen relative flex flex-col overflow-hidden bg-transparent text-white font-display">
            ...
            {/* Header */}
            <header className="relative z-10 border-b border-white/5 bg-black/40 backdrop-blur-xl px-8 py-5">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <div className="bg-primary p-2.5 rounded-xl shadow-[0_0_20px_rgba(234,42,51,0.3)] border border-primary/20">
                ...
                <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    ...
                    >
                        <div className="space-y-6">
                            ...
                            <h2 className="text-7xl md:text-8xl font-black leading-[0.9] tracking-tighter italic">
                                DRAFT. <br />
                                BID. <br />
                        ...
                        <div className="grid grid-cols-2 gap-6 max-w-md">
                            <div className="bg-white/5 border border-white/10 rounded-[32px] p-6 backdrop-blur-xl group hover:border-primary/30 transition-all">
                                ...
                                <p className="text-2xl font-black italic">42 ROOMS</p>
                            </div>
                            <div className="bg-white/5 border border-white/10 rounded-[32px] p-6 backdrop-blur-xl group hover:border-green-400/30 transition-all">
                                ...
                                <p className="text-2xl font-black italic">1.2K ONLINE</p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="relative bg-surface-dark/40 backdrop-blur-3xl border border-white/5 rounded-[48px] p-10 md:p-14 shadow-[0_40px_100px_rgba(0,0,0,0.5)]">
                            <div className="mb-12">
                                <h3 className="text-4xl font-black mb-3 italic tracking-tight">JOIN THE ARENA</h3>
                                <p className="text-white/40 text-lg font-medium">Enter your credentials to begin the bidding war.</p>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className="space-y-3">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-black/40 border-2 border-white/5 rounded-[20px] py-4 px-14 text-lg font-bold text-white placeholder:text-white/10 focus:border-primary/40 focus:ring-0 transition-all outline-none"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="relative group">
                                        <Trophy className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-white/20 group-focus-within:text-primary transition-colors" />
                                        <input
                                            type="text"
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="relative group">
                                        <Key className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-white/20 group-focus-within:text-primary transition-colors" />
                                        <input
                                            type="text"
                                            placeholder="#R-902-AX"
                                            value={roomId}
                                            onChange={(e) => setRoomId(e.target.value)}
                                            className="w-full bg-black/40 border-2 border-white/5 rounded-[20px] py-4 px-14 text-2xl font-black text-primary placeholder:text-white/10 focus:border-primary/40 focus:ring-0 transition-all outline-none italic tracking-tighter"
                                        />
                                    </div>
                                </div>
                                ...
                                <button
                                    ...
                                    className="w-full bg-primary hover:bg-red-700 text-white font-black text-xl py-5 rounded-[24px] shadow-[0_20px_40px_rgba(234,42,51,0.3)] hover:shadow-[0_25px_60px_rgba(234,42,51,0.4)] transition-all hover:-translate-y-1 active:translate-y-0 flex items-center justify-center gap-4 group"
                                >
                                    CONTINUE TO LOBBY
                                ...
                                <button
                                    ...
                                    className="w-full bg-white/5 border-2 border-white/5 hover:border-white/20 text-white font-black py-4 rounded-[24px] transition-all flex items-center justify-center gap-2 uppercase tracking-widest text-sm"
                                >
                                    CREATE SECURE ROOM
                                </button>
                            </div>
            ...
            <footer className="relative z-10 px-12 py-8 text-[10px] font-black text-white/20 uppercase tracking-[0.5em] flex flex-col md:flex-row justify-between items-center gap-6">
